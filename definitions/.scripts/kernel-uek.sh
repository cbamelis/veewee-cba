...
rhel5 wget http://public-yum.oracle.com/public-yum-el5.repo -P /etc/yum.repos.d/
rhel6 wget http://public-yum.oracle.com/public-yum-ol6.repo -P /etc/yum.repos.d/
